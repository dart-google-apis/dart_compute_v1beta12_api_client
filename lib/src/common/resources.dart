...
class InstancesResource extends Resource {
  ...
  Future<Operation> addAccessConfig(AccessConfig request, String project, String instance, String network_interface, {Map optParams}) {
    var completer = new Completer();
    var url = "{project}/instances/{instance}/add-access-config";
    var urlParams = new Map();
    var queryParams = new Map();
  ...
  Future<Operation> deleteAccessConfig(String project, String instance, String access_config, String network_interface, {Map optParams}) {
    var completer = new Completer();
    var url = "{project}/instances/{instance}/delete-access-config";
    var urlParams = new Map();
    var queryParams = new Map();
...
class MachineTypesResource extends Resource {
  ...
  Future<MachineType> get(String project, String machineType, {Map optParams}) {
    var completer = new Completer();
    var url = "{project}/machine-types/{machineType}";
    var urlParams = new Map();
    var queryParams = new Map();
...
class ProjectsResource extends Resource {
   ...
   * [optParams] - Additional query parameters
   */
  Future<Map> setCommonInstanceMetadata(Metadata request, String project, {Map optParams}) {
    var completer = new Completer();
    var url = "{project}/set-common-instance-metadata";
    var urlParams = new Map();
    var queryParams = new Map();
